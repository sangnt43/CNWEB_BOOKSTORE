<div class="card">
    <div class="card-body">
        <h4 class="card-title font-weight-bold">Thêm sản phẩm</h4>
        <hr>
        <div class="form-row">
            <div class="col-sm-12">
                <div class="col-sm-">
            ...
            <div class='col-md-6'>
                <div class='form-group'>
                    ...
                    <select2 v-model="book.bookCategory" :options="categoryList" :settings="{ placeholder: 'Chọn thể loại', width:'100%' }"></select2>
                    <i class='form-group__bar'></i>
                </div>
            </div>
            <div class='col-md-6'>
            ...
            <div class='col-12'>
                <div class='form-group'>
                    ...
                    <div class="p-2 my-2 d-flex" style="border: 1px solid #eceff1;max-width: 100%;flex-wrap: wrap">
                        <div class="MyImage m-2 shadow" v-for="image in book.imageList">
            ...
            <div class='col-md-12'>
                <div class='form-group'>
                    <label class="font-weight-bold">Seo <strong>*</strong><span class="text-danger" v-if="isError('seo')">Chưa nhập Seo</span></label>
            ...
            <button @click="sendData" type="submit" class="btn btn-block btn-sm bg-red text-white waves-effect"><strong>Thêm</strong></button>
        </div>
    </div>
</div>