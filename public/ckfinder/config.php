...
$public_dir = dirname(__DIR__, 1);
$base_dir = dirname(__DIR__, 2) . DIRECTORY_SEPARATOR;

$base_url = "http://localhost/CNWEB/";


// require_once ($base_dir.DIRECTORY_SEPARATOR."application".DIRECTORY_SEPARATOR."config".DIRECTORY_SEPARATOR."sq_config.php");

// $media_dir = $base_dir.DIRECTORY_SEPARATOR."media";
// $return_url = $sq_base_url."media";
...
$config['backends'][] = array(
    ...
    'adapter'      => 'local',
    'baseUrl'      => $base_url,
    'root'         => $public_dir, // Can be used to explicitly set the CKFinder user files directory.
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
